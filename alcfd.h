...
#include "srcs/init_sampling.h"
#include "srcs/processing.h"
#include "srcs/re_sampling.h"
#include "srcs/record.h"
#include "srcs/rule.h"
#include "srcs/using_name.h"
#include "srcs/using_name_sp.h"
...
class al_cfd {
 ...
 private:
  ...
  template <typename T>
  void append_predicate_into_rule(const T& tuplePair, const Rule& rule, std::vector<bool> feature,
