...
class Record {
 ...
 public:
  ...
  std::string at(unsigned i) const { return data.at(i); }

  std::size_t size() const { return data.size(); }

  void set_data(unsigned i, std::string str) { data[i] = std::move(str); }

  void set_label(bool label_) { label = label_; }
  ...
  std::string get_data(unsigned index) const { return data[index]; }
