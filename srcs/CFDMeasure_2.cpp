...
VecUint find_certain_value_set_2(unsigned attr_id, std::vector<Pli>& plis, const VecSpRec& records,
...
void CFDMeasure_2::preprocess(std::vector<Pli>& plis, const VecStr& attributes, const VecSpRec& records) {
...
void CFDMeasure_2::create_pliRecords(UpVecUpVecInt& pliRecords, const std::vector<Pli>& plis, const VecStr& attributes,
...
int CFDMeasure_2::compute_support(const VecStr& attributes, const VecSpRec& records, const Rule& rule,
