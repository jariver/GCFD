...
VecUint find_certain_value_set_(unsigned attr_id, std::vector<Pli>& plis, const VecSpRec& records,
...
void CFDMeasure::preprocess(std::vector<Pli>& plis, const VecStr& attributes, const VecSpRec& records) {
  clock_t t0 = clock();
...
void CFDMeasure::create_pliRecords(UpVecUpVecInt& pliRecords, const std::vector<Pli>& plis, const VecStr& attributes,
...
unsigned CFDMeasure::compute_support(const VecStr& attributes, const VecSpRec& records, const Rule& rule,
