...
class CFDMeasure_2 {
 public:
  ...
  static int compute_support(const VecStr& attributes, const VecSpRec& records, const Rule& rule,
  ...
  static int compute_violation(const VecStr& attributes, const VecSpRec& records, const Rule& rule,
                               const PredicatesSpace& predicates_space);
