...
class init_sampling {
 public:
  static void execute(VecVecUint& lst_tuple_pair, VecPre& vec_predicates, VecVecUint& combination,
  ...
  static void create_frequency_items(VecPre& vec_predicates, const std::vector<Pli>& plis, const VecStr& attributes,
                                     const VecSpRec& records);

  static void sampling_tuple_pairs_pliRecords(VecVecUint& lst_tuple_pair, VecVecUint& combination,
