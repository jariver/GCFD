...
class CFDMeasure {
 public:
  static unsigned compute_support(const VecStr& attributes, const VecSpRec& records, const Rule& rule,
                                  const PredicatesSpace& predicates_space);

  static unsigned compute_violation(const VecStr& attributes, const VecSpRec& records, const Rule& rule,
                                    const PredicatesSpace& predicates_space);

  static void compute_confidence(const VecStr& attributes, const VecSpRec& records, const Rule& rule,
                                 const PredicatesSpace& predicates_space);
